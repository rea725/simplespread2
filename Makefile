...
#
##APPLICATION_NAMESPACE = com.reasonsphere.x4view
...
APPLICATION_MAKE_TITLE = X4VIEW
APPLICATION_API_TITLE = X4View
APPLICATION_URI = resource/qx


# Generate a single JavaScript file
APPLICATION_SCRIPT_FILENAME = x4view.js
...
APPLICATION_LOCALES = en de es fr
